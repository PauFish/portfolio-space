!function (t, e, i, n) {
    ...
    function D(t, e) {
        ...
        e.overallVelocity = mt(c.x) > mt(c.y)
            ? c.x
            : c.y,
        e.scale = o
            ? X(o.pointers, n)
    ...
    l(k, I, {
        handler: function _e(t) {
            ...
            s & Pt && (0 === t.button || o)
                ...
                : s & (Rt | Mt) && (i = !0),
            0 > a || (e[a] = t, this.callback(this.manager, s, {
                pointers: e,
                changedPointers: [t],
                pointerType: r,
                srcEvent: t
    ...
    G.prototype = {
        set: function (t) {
            t == ae && (t = this.compute()),
            oe && this.manager.element.style && pe[t] && (
    ...
    l(ot, et, {
        ...
        attrTest: function (t) {
            ...
            this
                ._super
                .attrTest
                .call(this, t) && e & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && mt(
                    i
                ) > this.options.velocity && t.eventType & Rt
        },
        emit: function (t) {
            var e = Q(t.offsetDirection);
            e && this
                .manager
                .emit(this.options.event + e, t),
            this
                .manager
                .emit(this.options.event, t)
        }
    }),
    l(at, J, {
        defaults: {
...
$(document).ready(function () {
    ...
    $(this).on("mousewheel DOMMouseScroll", function (e) {
        if (!$(".outer-nav").hasClass("is-vis")) {
            ...
            i > 50 && o
                ? (o = !1, clearTimeout(a), a = setTimeout(function () {
                    o = !0
                }, 800), t(1))
                : -50 > i && o && (o = !1, clearTimeout(a), a = setTimeout(function () {
                    o = !0
                }, 800), t(-1))
        }
    }),
